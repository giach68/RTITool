...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue May 22 10:08:56 2018
# Project:  RTITool.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile RTITool.pro
#############################################################################
